...
function RightSideBar() {
  const openClick = (e) => {
    ...
    bodyElem.className += " sidebar-active right-sidebar-active";
  };

  const closeClick = (e) => {
    e.preventDefault();
    const bodyElem = document.querySelector("body");
    bodyElem.className = "loaded";
  };
  return (
    <aside className="sidebar product-sidebar sidebar-fixed right-sidebar sticky-sidebar-wrapper">
      <div className="sidebar-overlay" />
      <a className="sidebar-close" href="#" onClick={closeClick}>
      ...
      <div className="sidebar-content scrollable">
        <div className="sticky-sidebar">
          ...
          <div className="widget widget-products">
            ...
            <div
              className="owl-carousel owl-theme owl-nav-top"
              data-owl-options="{
                              'nav': true,
                              'dots': false,
                              'items': 1,
                    ...
                    <div className="comment-body">
                      ...
                      <div className="comment-content">
                        ...
                        <p>
                          ...
                          cursus turpis massa tincidunt ante in nibh mauris
                          cursus mattis. Cras ornare arcu dui vivamus arcu felis
                    ...
                    <div className="comment-body">
                      ...
                      <div className="comment-content">
                        ...
                        <p>
                          ...
                          sapien. Ultrices eros in cursus turpis massa tincidunt
                          ante in nibh mauris cursus mattis. Cras ornare arcu
                    ...
                    <div className="comment-body">
                      ...
                      <div className="comment-content">
                        ...
                        <p>
                          ...
                          tristique senectus et. In dictum non consectetur a
                          erat. Nunc scelerisque viverra mauris in aliquam sem
                          fringilla.
                        </p>
                        <div className="comment-action">
                          <a
